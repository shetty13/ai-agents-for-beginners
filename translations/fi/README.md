...
>
> Tämä arkisto sisältää yli 50 käännöstä, mikä lisää merkittävästi latauskokoa. Kloonaaksesi ilman käännöksiä, käytä suppeaa checkoutia:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Jos haluat käyttää lisäkielien käännöksiä, tuetut kielet löytyvät [tästä](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**

[![GitHub-katselijat](https://img.shields.io/github/watchers/microsoft/ai-agents-for-beginners.svg?style=social&label=Watch)](https://GitHub.com/microsoft/ai-agents-for-beginners/watchers/?WT.mc_id=academic-105485-koreyst)
...
Tällä kurssilla on oppitunteja, jotka käsittelevät AI-agenttien rakentamisen perusteita. Jokainen oppitunti käsittelee omaa aihettaan, joten aloita mistä haluat!

Kurssilla on monikielituki. Siirry saatavilla oleviin kieliin [tästä](../..).

Jos rakennat ensimmäistä kertaa generatiivisilla tekoälymalleilla, tutustu [Generative AI For Beginners](https://aka.ms/genai-beginners) -kurssiimme, joka sisältää 21 oppituntia generatiivisen tekoälyn käyttöön rakentamiseen.

Älä unohda [tähtää (🌟) tätä repositoriota](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) ja [haaraa tätä repositoriota](https://github.com/microsoft/ai-agents-for-beginners/fork) ajaaksesi koodia.
...
Jokainen kurssin oppitunti sisältää koodiesimerkkejä, jotka löytyvät kansion code_samples alta. Voit [haarata tämän repositorion](https://github.com/microsoft/ai-agents-for-beginners/fork) luodaksesi oman kopiosi.

Näissä harjoituksissa oleva koodiesimerkki käyttää Azure AI Foundrya ja GitHubin Mallikatalogeja kielimallien kanssa toimimiseen:

- [Github Models](https://aka.ms/ai-agents-beginners/github-models) - Ilmainen / rajoitettu
- [Azure AI Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Tarvitsee Azure-tilin

Tässä kurssissa käytetään myös seuraavia Microsoftin AI-agenttikehyksiä ja palveluita:
...
Lisätietoja koodin ajamisesta tälle kurssille saat kohdasta [Course Setup](./00-course-setup/README.md).
...
| Työkalujen käyttöön perustuva suunnittelumalli | [Linkki](./04-tool-use/README.md)                   | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Linkki](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Kiitos [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) tärkeistä koodiesimerkeistä, jotka osoittavat Agentic RAG:n käytön.

## Osallistuminen

Tähän projektiin otetaan mielellään vastaan ehdotuksia ja panoksia. Useimmat panokset edellyttävät, että hyväksyt
Contributor License Agreement (CLA) -sopimuksen, jossa vahvistat, että sinulla on oikeus ja että oikeasti myönnät meille
oikeudet käyttää panostasi. Lisätietoja: <https://cla.opensource.microsoft.com>.

Kun lähetät pull-pyynnön, CLA-botti tarkistaa automaattisesti, tarvitseeko sinun toimittaa CLA ja merkitsee PR:n asianmukaisesti (esimerkiksi tilantarkistus, kommentti). Noudata vain botin ohjeita. Tämä pitää tehdä vain kerran kaikissa CLA:ta käyttävissä repositorioissamme.

Tämä projekti on hyväksynyt [Microsoftin avoimen lähdekoodin käyttäytymissäännöt](https://opensource.microsoft.com/codeofconduct/).
Lisätietoja löytyy [Käyttäytymissääntöjen UKK](https://opensource.microsoft.com/codeofconduct/faq/) -sivulta tai ota yhteyttä osoitteeseen [opencode@microsoft.com](mailto:opencode@microsoft.com) jos sinulla on lisäkysymyksiä tai kommentteja.

## Tavaranmerkit

Tämä projekti voi sisältää tavaramerkkejä tai logoja projekteista, tuotteista tai palveluista. Microsoftin
tavaramerkkien tai logojen luvallinen käyttö edellyttää Microsoftin
[Tavaramerkkien ja brändiohjeiden](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) noudattamista.
Microsoftin tavaramerkkien tai logojen käyttö muokatuissa versioissa ei saa aiheuttaa sekaannusta tai antaa ymmärtää Microsoftin sponsoroivan.
Kolmansien osapuolien tavaramerkkien tai logojen käyttö on näiden osapuolten ehtojen alaista.

## Saat apua

Jos olet jumissa tai sinulla on kysymyksiä AI-sovellusten rakentamisesta, liity:
